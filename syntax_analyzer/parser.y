...
expr:	assignexpr 			{$$ = Manage_expr__assignexpr();}
		...
		| expr GT expr 		{$$ = Manage_expr__expr_GT_expr(sym_table,$1,$2,yylineno);}
		| expr GE expr 		{$$ = Manage_expr__expr_GE_expr(sym_table,$1,$2,yylineno);}
		| expr LT expr 		{$$ = Manage_expr__expr_LT_expr(sym_table,$1,$2,yylineno);}
		| expr LE expr 		{$$ = Manage_expr__expr_LE_expr(sym_table,$1,$2,yylineno);}
		| expr EQ expr 		{$$ = Manage_expr__expr_EQ_expr(sym_table,$1,$2,yylineno);}
		| expr NE expr 		{$$ = Manage_expr__expr_NE_expr(sym_table,$1,$2,yylineno);}
