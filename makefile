...
acc: $(CORE_OBJ_FILES) $(ALPHA_LEX_OBJ_FILES) $(SYNTAX_ANALYZER_OBJ_FILES) $(ICODE_OBJ_FILES) $(TCODE_OBJ_FILES) $(TCODE_GFUNC_OBJ_FILES) $(COMM_INTR_OBJ_FILES) $(COMM_INTR_ERR_OBJ_FILES)
	$(CPP) $(CXXFLAGS) $^ -o $(EXEC_ACC)

avm: $(VM_OBJ_FILES) $(VM_AVM_OBJ_FILES) $(VM_AVM_BUILT_IN_FUNCS_OBJ_FILES) $(VM_AVM_DISPATCHER_OBJ_FILES) $(VM_AVM_ERRS_OBJ_FILES) $(VM_AVM_PSTACK_OBJ_FILES) $(VM_RDP_OBJ_FILES) $(COMM_INTR_OBJ_FILES) $(COMM_INTR_ERR_OBJ_FILES)
